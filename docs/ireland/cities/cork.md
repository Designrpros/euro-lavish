---
title: 🏙️ Cork - Ireland
description: Cost of Living in Cork
---

# 🏙️ Cork

<iframe width="100%" height="300" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://www.openstreetmap.org/export/embed.html?bbox=-8.5%2C51.8%2C-8.1%2C52.0&layer=mapnik"></iframe>
...
|----------|-------------|
| 🏋️ **Gyms & Fitness** | [Find Gyms in Cork](https://www.google.com/maps/search/Gym+and+Workout+in+Cork) |
| 🧖 **Spas & Wellness** | [Find Spas in Cork](https://www.google.com/maps/search/Spa+and+Wellness+in+Cork) |
...
| Service | Link |
|---------|------|
| [Booking.com](https://www.booking.com/searchresults.html?ss=Cork) | Hotels |
...
- **Coworking**: [Find local workspaces](https://www.google.com/maps/search/Cork+Coworking/)
