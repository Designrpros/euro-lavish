---
title: 🇱🇻 Latvia
description: Complete cost of living guide for Latvia
---

# 🇱🇻 Latvia

<iframe width="100%" height="350" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://www.openstreetmap.org/export/embed.html?bbox=23.27%2C55.85%2C25.93%2C57.85&layer=mapnik"></iframe>

## 📊 Cost of Living

| Category | Price | EUR |
|----------|-------|-----|
| Rent (city center) | 550€ | ~550 EUR |
| Meal | 12€ | ~12 EUR |
| Beer (0.5L) | 4€ | ~4 EUR |
| Cappuccino | 3€ | ~3 EUR |
...
| 🥾 **Hiking Trails** | [Find Trails in 🇱🇻 Latvia](https://www.google.com/maps/search/Hiking+Trails+in+🇱🇻+Latvia) |

## 🇪🇺 European Resident Info

| Category | Details |
|----------|---------|
| **Status** | Northern Europe |
